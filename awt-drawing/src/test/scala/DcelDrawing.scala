...
/*
  Await.result(addPoly(List(V2(-384.0, -384.0), V2(-384.0, -512.0), V2(-512.0, -512.0), V2(-512.0, -384.0))), Duration.Inf)
  Await.result(addPoly(List(V2(-384.0, -256.0), V2(-384.0, -384.0), V2(-512.0, -384.0), V2(-512.0, -256.0))), Duration.Inf)*/
  println()
}
