...
//    val poly = List(V2(-213.0, 414.0), V2(-273.0, 353.0), V2(-358.0, 361.0), V2(-393.0, 310.0), V2(-389.0, 254.0), V2(-343.0, 230.0), V2(-170.0, 249.0), V2(-87.0, 116.0), V2(-233.0, 41.0), V2(-157.0, -67.0), V2(93.0, 14.0), V2(277.0, 164.0), V2(91.0, 173.0), V2(183.0, 330.0), V2(145.0, 535.0))
  ...
  test("lineSideBugTest") {
    val poly = List((List(V2(200.0, 200.0), V2(200.0, 0.0))), (List(V2(300.0, 300.0), V2(300.0, 0.0))), (List(V2(100.0, 400.0), V2(100.0, 100.0))), (List(V2(200.0, 400.0), V2(200.0, 300.0))), (List(V2(-100.0, 100.0), V2(-100.0, 0.0))), (List(V2(-200.0, 400.0), V2(-200.0, 0.0), V2(400.0, 0.0), V2(400.0, 400.0))))
    testTriag(poly)
  }
//  test("bug7") {
